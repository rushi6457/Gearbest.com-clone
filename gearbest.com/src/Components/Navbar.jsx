        ...
        {/* ❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌ */}
            <Menu>
                ...
                <MenuList width='300px'>
                    ...
                    <Button backgroundColor='blue.200' width='80%'marginTop='20px' marginBottom='15px'>Register</Button>
                </MenuList>
            </Menu>
        {/* ❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌❌ */}
            ...
            <Flex marginTop='30px' marginLeft='-10px' alignItems='center' >
                <BsCart2 size='25px' />
                <Text marginLeft='10px'>Cart</Text>
            </Flex>
    </Flex>  
    </> 
    );
